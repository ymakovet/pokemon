...
final class PokemonListTempModel {
...
extension PokemonListTempModel: PokemonListModel {
    ...
    func getPokemonDetails(index: Int, completion: @escaping (PokemonDetailsResponse) -> Void) {
        getPokemonDetailsRequest(index: index) { [weak self] (result) in
